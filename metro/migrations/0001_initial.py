# Generated by Django 6.0 on 2025-12-12 20:56
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('public_key', models.TextField(db_index=True, help_text='Cryptographic public key for the node', unique=True)),
                ...
                ('estimated_range', models.PositiveIntegerField(default=1000, help_text='Estimated coverage range in meters (used for map visualization)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('node', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='telemetry_readings', to='metro.node')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timestamp', models.DateTimeField(auto_now_add=True, db_index=True)),
                ('session', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='metro.mappingsession')),
            ],
            options={
                'verbose_name': 'Trace',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('neighbour', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='heard_by', to='metro.node')),
                ('node', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='neighbours', to='metro.node')),
            ],
            options={
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['target_node', '-start_time'], name='metro_mappi_target__887d1d_idx'),
        ),
        migrations.AddIndex(
            model_name='trace',
            index=models.Index(fields=['session', '-timestamp'], name='metro_trace_session_4acaa2_idx'),
        ),
    ]
